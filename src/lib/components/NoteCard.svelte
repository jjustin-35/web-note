...
<div
  class="group {colorClasses[
    note?.color || 'yellow'
  ]} rounded-lg shadow-sm hover:shadow-md transition-all p-4 cursor-pointer"
>
  <div class="flex justify-between items-start mb-3">
    ...
    <div class="flex justify-between items-start">
      ...
      <button on:click={handleDelete} class="text-gray-500 hover:text-red-500">
  ...
  <div class="flex flex-wrap gap-2 mt-4">
    <span class="px-2 py-1 rounded text-xs {colorClasses[note?.color || 'yellow']}">
